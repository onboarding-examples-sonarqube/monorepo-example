...
from lib.utils import format_string, validate_email, process_user_input
...
if __name__ == "__main__":
    ...
    for group, group_users in result.items():
        ...
        for user in group_users:
            ...
            # Using the process_user_input function SAFELY - sanitize=True (default)
            # This should NOT trigger SonarQube issues
            safe_result = process_user_input(user['name'])
            print(f"    Processing result: {safe_result['status']}")
